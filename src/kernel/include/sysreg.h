...
/* MAIR (memory attribute) indices */

#define MEMATTR_DEVICE_IDX             0
...
#define MEMATTR_NORMAL_UNCACHEABLE     AA64_MEM_NORMAL_NC
#define MEMATTR_NORMAL_WRITEBACK       AA64_MEM_NORMAL_WBNT
